  ...
  return (
    <div className="panel">
      ...
      <p className="panel-sub">
        ...
        months 568–601). The serving baseline decays under drift; the
        velocity candidate already wins the test split (0.7646) but stays
        gated until a full-data training run passes the val gate on the T4.
      </p>
      ...
      {race && (
        <>
          ...
          {race.models
            ...
            .slice(0, 8)
            .map((m) => (
              <div className="audit-row race-row" key={m.name}>
